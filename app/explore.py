...
class ExploreFunctionTest():
    ...
    def GainedResources(playerdetails, end, gekozen_aantal, Resources):
        ...
        end = end + 'Je bent een vervallen gebouw tegenkomen. Uit dit gebouw heb je ' + str(
            Resources) + ' resources kunnen halen.'
        return end

    @staticmethod
    def GainedSoldiers(playerdetails, end, gekozen_aantal, Soldiers):
        playerdetails.Soldiers = playerdetails.Soldiers + Soldiers
        return 'Je hebt een klein kamp gevonden met vriendelijke overlevenden. Ze willen graag bij je sluiten. Je hebt ' + str(
            Soldiers) + ' soldaten gekregen.'
...
class ExploreFunction():
    ...
    def GainedSoldiers(playerdetails, end, gekozen_aantal):
        ...
        playerdetails.Soldiers = playerdetails.Soldiers + Soldiers
        end = end + 'Je hebt een klein kamp gevonden met vriendelijke overlevenden. Ze willen graag bij je sluiten. Je hebt ' + str(
            Soldiers) + ' soldaten gekregen.'
        playerdetails.save()
        return end
    ...
    def ExploreSucces(playerdetails, end, gekozen_aantal):
        ...
        playerdetails.Resources = playerdetails.Resources + Resources
        playerdetails.save()
        end = end + 'Zoektocht geslaagd! Je hebt je eigen dorp weer bereikt met een extra bonus van ' + str(
            Resources) + '! '
        return end
